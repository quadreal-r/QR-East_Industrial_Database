...
Computation lives in `@/lib/costEstimator`; Excel export in `@/lib/excel` (`exportRcbExcel`); PDF export in `@/lib/rcbPdf` (`exportRcbPdf`) — presentation workbook with Dashboard, By Building, Cost of Waiting, By Unit Size, and All Units sections.
