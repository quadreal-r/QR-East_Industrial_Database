...
Computation lives in `@/lib/costEstimator`; Excel export in `@/lib/excel` (`exportRcbExcel`); PDF export in `@/lib/rcbPdf` (`exportRcbPdf`) — presentation workbook with Dashboard, RTU Pricing, By Building, By Unit Size, and All Units sections.
